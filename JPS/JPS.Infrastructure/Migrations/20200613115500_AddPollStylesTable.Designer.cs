...
namespace JPS.Domain.Entities.Migrations
{
    ...
    [Migration("20200613115500_AddPollStylesTable")]
    partial class AddPollStylesTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("JPS.Domain.Entities.Entities.PollStyleEntity", b =>
                {
                    ...
                    b.Property<double?>("ImageXCoordinate")
                        .HasColumnType("float");

                    b.Property<double?>("ImageYCoordinate")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("JPS.Domain.Entities.Entities.PollStyleEntity", b =>
                {
                    b.HasOne("JPS.Domain.Entities.Entities.PollEntity", "Poll")
                        .WithOne("PollStyle")
                        .HasForeignKey("JPS.Domain.Entities.Entities.PollStyleEntity", "PollId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
