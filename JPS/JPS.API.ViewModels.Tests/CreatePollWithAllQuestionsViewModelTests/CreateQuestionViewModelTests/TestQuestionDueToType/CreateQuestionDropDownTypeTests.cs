...
{
	[TestClass]
	public class CreateQuestionDropDownTypeTests
    {
		[TestMethod]
		public void TestCreateQuestionDropdown_OptionsAreNull_ShouldBeFailed()
		{
		...
		[TestMethod]
		public void TestCreateQuestionDropdown_OptionsWithValue_ShouldBeFailed()
		{
		...
		[TestMethod]
		public void TestCreateQuestionDropdown_ListOfRowsNull_ShouldBePassed()
		{
			List<CreateOptionForQuestionViewModel> options = new List<CreateOptionForQuestionViewModel>
			{
				new CreateOptionForQuestionViewModel() { Text="Ttext",ImageUrl="url", Order = 4},
		...
		[TestMethod]
		public void TestCreateQuestionDropdown_WithRows_ShouldBeFailed()
		{
			List<CreateOptionForQuestionViewModel> options = new List<CreateOptionForQuestionViewModel>
			{
				new CreateOptionForQuestionViewModel() { Text="Ttext",ImageUrl="url", Order = 4},
		...
		[TestMethod]
		public void TestCreateQuestionDropdown_OnlyOneOption_ShouldBeFailed()
		{
			List<CreateOptionForQuestionViewModel> options = new List<CreateOptionForQuestionViewModel>
			{
				new CreateOptionForQuestionViewModel() { Text="Ttext",ImageUrl="url", Order = 4},
		...
		[TestMethod]
		public void TestCreateQuestionDropdown_OptionsWithSameOrder_ShouldBeFailed()
		{
			List<CreateOptionForQuestionViewModel> options = new List<CreateOptionForQuestionViewModel>
			{
				new CreateOptionForQuestionViewModel() { Text="Ttext",ImageUrl="url", Order = 4},
		...
		[TestMethod]
		public void TestCreateQuestionDropDown_GivenOtherOptionFlag_ShouldBeFailed()
		{
			List<CreateOptionForQuestionViewModel> options = new List<CreateOptionForQuestionViewModel>
			{
				new CreateOptionForQuestionViewModel() { Text="Ttext",ImageUrl="url", Order = 4},
		...
		private static CreateQuestionsViewModel GetCreateQuestionViewModel(
			...
			IEnumerable<CreateOptionForQuestionViewModel> options = null,
				...
				string videoUrl = "uek",
				int order = 1,
				int questionTypeId = (int)QuestionTypes.Dropdown
		)
		{
