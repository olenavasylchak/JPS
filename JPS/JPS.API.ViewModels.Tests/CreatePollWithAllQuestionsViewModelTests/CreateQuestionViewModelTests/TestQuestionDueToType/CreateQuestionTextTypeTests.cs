...
{
	[TestClass]
	public class CreateQuestionTextTypeTests
	{
		[TestMethod]
		public void TestCreateQuestionText_GivenLisnOfOptions_ShouldBePassed()
        {
		...
		[TestMethod]
		public void TestCreateQuestionText_GivenLisnOfOptionRows_ShouldBePassed()
		{
		...
		[TestMethod]
		public void TestCreateQuestionText_OptionsAreGiven_ShouldBeFailed()
		{
			List<CreateOptionForQuestionViewModel> options = new List<CreateOptionForQuestionViewModel>
			{
		...
		[TestMethod]
		public void TestCreateQuestionText_OptionRowsAreGiven_ShouldBePassed()
		{
			List<CreateOptionRowForQuestionViewModel> rows = new List<CreateOptionRowForQuestionViewModel>
			{
		...
		[TestMethod]
		public void TestCreateQuestionText_GivenOtherOptionFlag_ShouldBeFailed()
		{
		...
		string videoUrl = "uek",
		int order = 1,
		int questionTypeId = (int)QuestionTypes.Text
)
		{
