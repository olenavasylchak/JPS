...
{
	[TestClass]
	public class CreateQuestionChoiceTypeTests
	{
		[TestMethod]
		public void TestCreateQuestionChoice_OptionsAreNull_ShouldBeFailed()
		{
		...
		[TestMethod]
		public void TestCreateQuestionChoice_OptionsWithValue_ShouldBeFailed()
		{
		...
		[TestMethod]
		public void TestCreateQuestionChoice_ListOfRowsNull_ShouldBePassed()
		{
			List<CreateOptionForQuestionViewModel> options = new List<CreateOptionForQuestionViewModel>
			{
				new CreateOptionForQuestionViewModel() { Text="Ttext",ImageUrl="url", Order = 4},
		...
		[TestMethod]
		public void TestCreateQuestionChoice_WithRows_ShouldBeFailed()
		{
			List<CreateOptionForQuestionViewModel> options = new List<CreateOptionForQuestionViewModel>
			{
				new CreateOptionForQuestionViewModel() { Text="Ttext",ImageUrl="url", Order = 4},
		...
		[TestMethod]
		public void TestCreateQuestionChoice_OnlyOneOption_ShouldBeFailed()
		{
			List<CreateOptionForQuestionViewModel> options = new List<CreateOptionForQuestionViewModel>
			{
				new CreateOptionForQuestionViewModel() { Text="Ttext",ImageUrl="url", Order = 4},
		...
		[TestMethod]
		public void TestCreateQuestionChoice_OptionsWithSameOrder_ShouldBeFailed()
		{
			List<CreateOptionForQuestionViewModel> options = new List<CreateOptionForQuestionViewModel>
			{
				new CreateOptionForQuestionViewModel() { Text="Ttext",ImageUrl="url", Order = 4},
		...
		[TestMethod]
		public void TestCreateQuestionCheckBox_GivenOtherOptionFlag_ShouldBePassed()
		{
			List<CreateOptionForQuestionViewModel> options = new List<CreateOptionForQuestionViewModel>
			{
				new CreateOptionForQuestionViewModel() { Text="Ttext",ImageUrl="url", Order = 4},
		...
		private static CreateQuestionsViewModel GetCreateQuestionViewModel(
			...
			IEnumerable<CreateOptionForQuestionViewModel> options = null,
				...
				string videoUrl = "uek",
				int order = 1,
				int questionTypeId = (int)QuestionTypes.MultipleChoice
		)
		{
