...
{
	[TestClass]
	public class CreateQuestionParagraphTypeTests
	{
		[TestMethod]
		public void TestCreateQuestionParagraph_GivenLisnOfOptions_ShouldBePassed()
        {
		...
		[TestMethod]
		public void TestCreateQuestionParagraph_GivenLisnOfOptionRows_ShouldBePassed()
		{
		...
		[TestMethod]
		public void TestCreateQuestionParagraph_OptionsAreGiven_ShouldBeFailed()
		{
			List<CreateOptionForQuestionViewModel> options = new List<CreateOptionForQuestionViewModel>
			{
		...
		[TestMethod]
		public void TestCreateQuestionParagraph_OptionRowsAreGiven_ShouldBePassed()
		{
			List<CreateOptionRowForQuestionViewModel> rows = new List<CreateOptionRowForQuestionViewModel>
			{
		...
		[TestMethod]
		public void TestCreateQuestionParagraph_GivenOtherOptionFlag_ShouldBeFailed()
		{
		...
		[TestMethod]
		public void TestCreateQuestionParagraph_Valid_ShouldBePassed()
		{
		...
		string videoUrl = "uek",
		int order = 1,
		int questionTypeId = (int)QuestionTypes.Paragraph
)
		{
