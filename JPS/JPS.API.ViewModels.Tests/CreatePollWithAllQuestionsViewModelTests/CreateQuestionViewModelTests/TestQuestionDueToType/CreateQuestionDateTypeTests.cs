...
{
	[TestClass]
	public class CreateQuestionDateTypeTests
	{
		[TestMethod]
		public void TestCreateQuestionDate_GivenLisnOfOptions_ShouldBePassed()
        {
		...
		[TestMethod]
		public void TestCreateQuestionDate_GivenLisnOfOptionRows_ShouldBePassed()
		{
		...
		[TestMethod]
		public void TestCreateQuestionDate_OptionsAreGiven_ShouldBeFailed()
		{
			List<CreateOptionForQuestionViewModel> options = new List<CreateOptionForQuestionViewModel>
			{
		...
		[TestMethod]
		public void TestCreateQuestionDate_OptionRowsAreGiven_ShouldBePassed()
		{
			List<CreateOptionRowForQuestionViewModel> rows = new List<CreateOptionRowForQuestionViewModel>
			{
		...
		[TestMethod]
		public void TestCreateQuestionDate_GivenOtherOptionFlag_ShouldBeFailed()
		{
		...
		[TestMethod]
		public void TestCreateQuestionDate_Valid_ShouldBePassed()
		{
		...
		string videoUrl = "uek",
		int order = 1,
		int questionTypeId = (int)QuestionTypes.Date
)
		{
