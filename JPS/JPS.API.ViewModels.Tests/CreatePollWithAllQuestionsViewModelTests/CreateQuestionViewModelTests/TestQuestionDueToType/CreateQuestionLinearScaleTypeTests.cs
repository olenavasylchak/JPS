...
{
	[TestClass]
    public class CreateQuestionLinearScaleTypeTests
	{
		[TestMethod]
		public void TestCreateQuestionLinearScale_OptionsAreNull_ShouldBeFailed()
		{
		...
		[TestMethod]
		public void TestCreateQuestionLinearScale_OptionsWithOutValue_ShouldBeFailed()
		{
		...
		[TestMethod]
		public void TestCreateQuestionLinearScale_OptionsDuplicateValue_ShouldBeFailed()
		{
			List<CreateOptionForQuestionViewModel> options = new List<CreateOptionForQuestionViewModel>
			{
				new CreateOptionForQuestionViewModel() { Text="Ttext",ImageUrl="url", Order = 3, Value=2},
				new CreateOptionForQuestionViewModel() { Text="Ttext2",ImageUrl="url2", Order = 4, Value=2},
			};
			var createViewModel = GetCreateQuestionViewModel(options: options);
			var result = Validator.TryValidateObject(
				createViewModel,
		...
		[TestMethod]
		public void TestCreateQuestionLinearScale_ListOfRowsNull_ShouldBePassed()
		{
			List<CreateOptionForQuestionViewModel> options = new List<CreateOptionForQuestionViewModel>
			{
				new CreateOptionForQuestionViewModel() { Text="Ttext",ImageUrl="url", Order = 4, Value=2},
				new CreateOptionForQuestionViewModel() { Text="Ttext",ImageUrl="url", Order = 3, Value=1},
			};
		...
		[TestMethod]
		public void TestCreateQuestionLinearScale_WithRows_ShouldBeFailed()
		{
			List<CreateOptionForQuestionViewModel> options = new List<CreateOptionForQuestionViewModel>
			{
				new CreateOptionForQuestionViewModel() { Text="Ttext",ImageUrl="url", Order = 4, Value=2},
		...
		[TestMethod]
		public void TestCreateQuestionLinearScale_OnlyOneOption_ShouldBeFailed()
		{
			List<CreateOptionForQuestionViewModel> options = new List<CreateOptionForQuestionViewModel>
			{
				new CreateOptionForQuestionViewModel() { Text="Ttext",ImageUrl="url", Order = 4,Value=1},
			};
			var createViewModel = GetCreateQuestionViewModel(options: options);
			var result = Validator.TryValidateObject(
				createViewModel,
		...
		[TestMethod]
		public void TestCreateQuestionLinearScale_OptionsWithSameOrder_ShouldBeFailed()
		{
			List<CreateOptionForQuestionViewModel> options = new List<CreateOptionForQuestionViewModel>
			{
				new CreateOptionForQuestionViewModel() { Text="Ttext",ImageUrl="url", Order = 4, Value=1},
		...
		[TestMethod]
		public void TestCreateQuestionLinearScale_GivenOtherOptionFlag_ShouldBeFailed()
		{
			List<CreateOptionForQuestionViewModel> options = new List<CreateOptionForQuestionViewModel>
			{
				new CreateOptionForQuestionViewModel() { Text="Ttext",ImageUrl="url", Order = 4, Value=2},
		...
		private static CreateQuestionsViewModel GetCreateQuestionViewModel(
			...
			IEnumerable<CreateOptionForQuestionViewModel> options = null,
				...
				string videoUrl = "uek",
				int order = 1,
				int questionTypeId = (int)QuestionTypes.LinearScale
		)
		{
